...
@app.command()
def add(site_name:str=typer.Argument(..., help="Add new site to the database."),
        ...
        backend_http2:bool=typer.Option(True, help="Use HTTP/2 on the backend"),
        backend_https:bool=typer.Option(True, help="Use HTTPs on the backend"),
